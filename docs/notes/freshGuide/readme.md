...
::: tip 💡 问题速查
大部分常见问题已整理至 [FAQ（常见问题汇总）](./0.常见问题汇总.html)，报到流程、宿舍、军训、学费、网络等均可直接查阅，建议优先浏览。
:::

---

[点击链接加入群聊【南京理工大学 2026 新生群】](https://qm.qq.com/q/bVxQS1j7Xy)
...
💸 **远离高额押金/培训费的兼职培训**  
对“在家学剪辑轻松赚钱”“新生自我提高课”“XX 学习班”等宣称需缴纳高额押金或培训费的兼职、培训活动，务必保持警惕，避免财产损失。  

📢 **警惕虚假群组邀请**  
切勿相信群组内自称“老师”、“学长”，要求加入所谓“官方通知群”的消息，以防误入诈骗群组。  

🚫 **坚决抵制刷单、约炮、裸聊**  
各类刷单、同城交友、低俗约炮等信息均为诈骗。您的裸聊截图——会被拿来威胁您。您参与的刷单——需要垫付巨额资金。相关内容均为诈骗，切勿参与。  
...
💲 **不要网贷**
请适度消费，不要超前消费，切勿接触网贷。每年南京高校都有欠债自杀、被抓的案例。如资金出现问题，优先与家人联系。切勿网贷！！欢迎关注戒社。
...
::: tip
推荐使用电脑端浏览优化体验。
[什么是电脑](/notes/freshGuide/选购指南/电脑选购.html)
:::
...
* ✅ **你可以自由复制、分发、修改和引用本项目中的代码，无需另行授权**，用于除商业用途外的各种场景，只需保留原作者署名和许可声明。  
  例如：

  * 将本项目的代码嵌入你自己的项目或网站；
  * 修改功能逻辑或相关字段后，重新发布为开源或闭源项目；
  * 用于教学、非商业服务、产品原型开发等场景。

* ✅ **你也可以在非商业目的下自由使用、修改和转载文档内容，无需另行授权**，但必须注明来源和作者。  
  例如：

  * 在学校内部分享指引内容，或将其整理为 PPT、PDF 用于讲解；
  * 在非营利博客、BBS、论坛或个人网站转载部分内容并注明出处；
  * 将指引内容补充修改后，用于面向新生的志愿公益介绍或答疑材料。但我们强烈建议你将补充修改的内容贡献至本项目。

* 🚫 **未经授权，禁止将手册内容用于任何商业用途**，包括但不限于商业出版、收费服务、盈利性平台再传播等。尤其禁止利用手册内容为个人或组织账号、群组、平台进行引流、吸粉、营销宣传等行为。
  例如：

  * 将文档内容搬运至微信公众号、小红书、知乎等平台，并在文章末尾引导用户关注、加群或跳转至某网站；
  * 将内容汇编成收费文档、电子书，或嵌入需付费查看的资料包；
